...
from utils.loss import single_contra_loss
import torch
...
def train(cfg,model,optimizer,lr_scheduler,sup_loader,semi_loader,epoch,settings):
    ...
    for i_train in range(len(sup_loader)):
        ...
        if CONTRA_LOSS:
            ...
            # unsupervised loss
            con_loss = single_contra_loss(rep_all,label_all,mask_all,TEMP,NUM_QE,NUM_NEG)
        else:
...
if __name__ == "__main__":
    cfg_dir = "/volume/CONSS_113/conf/"
    cfg_path = cfg_dir + "f3_conss.yaml"
